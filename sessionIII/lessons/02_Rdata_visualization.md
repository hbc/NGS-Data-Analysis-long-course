...
dev.off() 
# this means "device off" and we will be going over what this does at the end of this section. For now, it makes it so that when we draw plots they show up where they are supposed to?
```
